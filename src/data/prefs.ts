...
export interface UserPrefs {
   ...
   * leaves the deck alone until it's taken; "always" leans the deck that way
   * on its own; "off" means the time of day never touches anything.
   *
   * Defaults to suggesting, because getting this wrong is worse than not
   * doing it: plenty of people's evening is not at 7pm, and a deck that
   * quietly rearranges itself by the clock reads as broken rather than clever.
   */
